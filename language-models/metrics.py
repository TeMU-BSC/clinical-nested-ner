"""Script to compute metrics with the model predictions"""
import json
from pathlib import Path
import pandas as pd
from collections import defaultdict

def compute_predictions(model, testset, scores_name, results_file=False):
    pass
...
if __name__ == '__main__':
    ...
    if read_metrics:
        ...
        df = df.groupby([8, 9, 11], as_index=False).agg({metric_name: ['mean', 'std'] for metric_name in metric_names})
