...
if __name__ == '__main__':
    ...
    for model in tqdm(pretrained_models):
        ...
        for testset in tqdm(testsets):
            if testset in model.split('/'):
                model_name = re.findall(f'.*runs/(.*{testset}.*)', model)[0]
                ...
                preds_dir = f'/home/ccasimiro/ccasimiro/clinical-nested-ner/language-models/cte-amd/preds/{model_name}'
